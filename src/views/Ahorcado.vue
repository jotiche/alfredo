<template>
  <div class="crossword mt-5 card">
    ...
    ¿Quieres una pista ?
  <a style='cursor: pointer;' v-on:click=" muestra_oculta('contenido')" title="" class="boton_mostrar">Mostrar / Ocultar</a>
</div>
<div id="contenido">
 <br>
      Pista  : {{pista}}
    ...
    <div class="card-body">
      <b-row >
        ...
        <b-col align-self="center" class="text-center mb-4 font-weight-bold" cols="12">
          <div v-for="(item,index) in showWord" :key="index" class="d-inline justify-content-center
          font-weight-bold center" style="text-align: center!important; font-size: 30px">
            {{showWord[index]}}
          </div>
        </b-col>
        <br>
        ...
        <b-col cols="1" l v-for="letter in letters" :key="letter" align-self="start">
            <b-button class="xd" @click="onLetter(letter)" pill size="sm">{{letter}}</b-button>
        </b-col>
      </b-row>
    </div>
            <div class="col-3">
